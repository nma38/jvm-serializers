...
public final class Media extends Table {
  ...
  public int heigh() { int o = __offset(10); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  ...
  public static void addHeigh(FlatBufferBuilder builder, int heigh) { builder.addInt(3, heigh, 0); }
